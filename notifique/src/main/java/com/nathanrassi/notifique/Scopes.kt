...
private const val APP_COMPONENT = "com.nathanrassi.notifique.APP_COMPONENT"
...
private class CustomServiceContextWrapper(context: Context, private val serviceName: String,
    private val service: Any) : LayoutInflaterCloningContextWrapper(context) {

...
internal class LegacyQueryDataSourceFactory<RowType : Any>(
  ...
  override fun create(): PositionalDataSource<RowType> =
    QueryDataSource(queryProvider, countQueryProvider, transacter)
}
      ...
      if (!isInvalid) {
        transacter.transaction {
          callback.onResult(
            ...
            totalCount = countQueryProvider().executeAsOne().toInt()
          )
        }
      }
    }
